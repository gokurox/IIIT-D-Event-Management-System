...
public class JDBCMySQLConnection {
	...
	* "club_management_system" - is the MySQL database name 
	*/
	public static final String URL = "jdbc:mysql://localhost:3306/club_management_system?autoReconnect=true&useSSL=false";
	/*
	 * Replace the following username and password with your MySQL username and password
	 */
